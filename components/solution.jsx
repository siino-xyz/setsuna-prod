...
export const Solution = () => {
  return (
    <>
      <InnerWidth>
        <Stack>
          <p>何かトラブルがあるたびに対応するのはリソースがもったいない。<br />初めから高速でセキュアなサイトを作ってしまえば、パフォーマンスチューニングやセキュリティ対策のランニングコストを大きく抑えられ、快適な運用ができると思いませんか？</p>
          <p>それを簡単に実現できる方法の1つがJamstack（ジャムスタック）です。<br />jamstack とは、J・A・M（JavaScript・API・Markup）の技術を使用した、ウェブサイトを構築するアーキテクチャの一つです。<br />技術的な話をするとキリがないので省きますが、コンセプトは非常にシンプルです。<br />従来型のウェブページ配信と何が違うのかを簡単に図式化しました。</p>
        </Stack>
        
        <StackContainer>
          <SubTitle 
            subtitle={"従来型のウェブページ配信"}
          />
          <Image 
